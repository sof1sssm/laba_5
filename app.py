...
app.secret_key = 'ybeac7cad4a6d24fe6ecee93b73165942' # секретный ключ, используется для защиты сессий и других данных
...
users_db = {} #Создает пустой словарь для хранения пользователей (не база данных)
